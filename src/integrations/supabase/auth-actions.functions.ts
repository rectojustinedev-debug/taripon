...
// Generates a Supabase "recovery" link with the admin/service-role client
// (so it works whether or not Supabase's own SMTP is configured) and
// delivers it ourselves through Brevo, using our own branded template,
// instead of relying on Supabase's built-in reset email.
